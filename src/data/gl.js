  ...
  /* ── 11. VAT & TAX COMPLIANCE ─────────────────────────────────────────────── */
  {
    ...
    processes: [
...

      {
        ...
        type: 'process',
        desc: 'MTD (Making Tax Digital) is a key part of the government\'s plans to make it easier for businesses to get their tax right first time and keep on top of their tax affairs. MTD requires businesses to record business transactions digitally, and in real time (or as close as possible). This will be underpinned by a requirement for subscribed businesses to send a summary of those records (a VAT Return) that will be generated and sent to HMRC using software or an app. VAT-registered businesses with a taxable turnover above the VAT threshold (£85,000) are now required to follow the Making Tax Digital rules by keeping digital records and using software to submit their VAT returns. If you are below the VAT threshold you can voluntarily join the Making Tax Digital service now. VAT-registered businesses with a taxable turnover below £85,000 will be required to follow Making Tax Digital rules for their first return starting on or after April 2022. In practice, this means maintaining an unbroken digital link from source transaction to the VAT return and submitting using MTD-compatible software — a legal requirement for all UK VAT-registered businesses, not an optional enhancement, so it must be addressed at every UK client\'s go-live rather than treated as a later phase.',
        activities: [
